...
def nearby_bird(lat, lng, distance_km, scientific_name, ebird_api_key):
    import requests
    import json
    import folium
    # Define the API endpoint URL
    #dis = 15km
    url = f'https://api.ebird.org/v2/data/obs/geo/recent?lat={lat}&lng={lng}&dist={distance_km}&sci={scientific_name}&fmt=json'
...
def nearby_bird_GAPI(lat, lng, distance_km, scientific_name, ebird_api_key):
    import requests
    import json
    import folium
    # Define the API endpoint URL
...
def gethotspot(lat, lng, ebird_api_key):
    import requests
    import json
    import folium
